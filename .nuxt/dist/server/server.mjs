import { hasInjectionContext, getCurrentInstance, reactive, toRef, isRef, inject, nextTick, shallowRef, computed, isReadonly, effectScope, ref, markRaw, toRaw, watch, unref, version, watchEffect, isShallow, isReactive, defineAsyncComponent, defineComponent, h, onUnmounted, Fragment, createVNode, Text, Suspense, mergeProps, Transition, provide, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/form-0a6aa14e.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-c6180a12.js").then((m) => m.default || m)
  },
  {
    name: "mundarija",
    path: "/mundarija",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/mundarija-9c26ec6a.js").then((m) => m.default || m)
  },
  {
    name: "not-found",
    path: "/not-found",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/not-found-ed192978.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/offline-f91b02a4.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/online-11af1b23.js").then((m) => m.default || m)
  },
  {
    name: "premium",
    path: "/premium",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/premium-11a51462.js").then((m) => m.default || m)
  },
  {
    name: "vip",
    path: "/vip",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/vip-0a52ca38.js").then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-d3e12395.js").then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-fca90dee.js").then((r) => r.default));
...
const layouts = {
  "home-layout": /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/homeLayout-ef4013ee.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-80d0e2d0.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-6ae3d565.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-d009eb23.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
