import { hasInjectionContext, getCurrentInstance, toRef, isRef, version, defineAsyncComponent, defineComponent, h, inject, onUnmounted, computed, unref, ref, watchEffect, watch, Fragment, Suspense, nextTick, mergeProps, Transition, provide, useSSRContext, createApp, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, Text, effectScope, markRaw, isShallow, isReactive, toRaw, withCtx } from 'vue';
import { $fetch } from 'ofetch';
import { createHooks } from 'hookable';
import { getContext, executeAsync } from 'unctx';
import { useRoute as useRoute$1, createMemoryHistory, createRouter, START_LOCATION, useRouter as useRouter$1, RouterView } from 'vue-router';
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-d009eb23.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
